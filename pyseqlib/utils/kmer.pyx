...
def Kmer_encoder(seq, last_seq_codes=None, K=10, base_list='ACGU'):
...
def Kmer_scan(fasta_file, out_dir=None, K=10, n_gene=None, base_list='ACGU'):
    """Scan Octmers in a sequence
    """
    N_base = len(base_list)
    if n_gene is None:
        n_gene = 170000 # a default big value
