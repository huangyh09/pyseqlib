...
if __name__ == "__main__":
    print("Welcome to GTF-convert!")

    # 0. parse command line options
    parser = OptionParser()
    parser.add_option("--annoFile", "-a", dest="anno_file", default=None,
        help="Input annotation file.")
    parser.add_option("--mode", "-m", dest="mode", default="TypeConv",
        help="Mode of convert.")
    parser.add_option("--out_file", "-o", dest="out_file", default=None, 
        help="Full path of output file [default: $gff_dir].")
    parser.add_option("--inType", dest="inType", default="GTF", 
        help="Type of input file [default: $gff_dir].")
    parser.add_option("--outType", dest="outType", default="GTF", 
        help="Type of output file [default: $gff_dir].")
